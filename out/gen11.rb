...
# $Id: gen11.rb,v 0.1 2008/09/19 14:50:36 arunachala Exp arunachala $
#
#
#######################################################
require 'rubygems'
...
#  sysfields.push(field) 
  ...
  field = FIELD.new(1, 10, 1*2, 1, 0, 0)
  ...
  field = FIELD.new(1, 10, 2*2, 1, 0, 0)
  field.set_field_back(A_UNDERLINE)
  ...
  field = FIELD.new(1, 10, 3*2, 1, 0, 0)
  field.set_field_back(A_UNDERLINE)
  ...
  field = FIELD.new(1, 10, 4*2, 1, 0, 0)
  field.set_field_back(A_UNDERLINE)
  ...
  field = FIELD.new(1, 10, 5*2, 1, 0, 0)
  field.set_field_back(A_UNDERLINE)
  ...
  field = FIELD.new(1, 10, 6*2, 1, 0, 0)
  field.set_field_back(A_UNDERLINE)
  ...
  field = FIELD.new(1, 10, 7*2, 1, 0, 0)
  field.set_field_back(A_UNDERLINE)
