...
class Mrowsnew
  ...
  def run
    ...
    begin
      ...
      print_header(@header_win, htext + " %15s "% @datasource.print_top_left + " %20s"%@datasource.print_top_center , posy, posx)
      print_top_right(@header_win, @datasource.print_top_right(1))
      ...
      restore_application_key_labels(@bottom_win)
      ...
      while((ch = my_form_win.getch()) != 197 )
        ...
        # at line 2,0 XXX
        print_top_right(@header_win, @datasource.print_top_right(get_curr_index))
        Ncurses.doupdate();
        Ncurses::Panel.update_panels();
        Ncurses.doupdate();
